#if BEST_SIGNALR_ENABLE_GAMEDEVWARE_MESSAGEPACK
...
namespace Best.SignalR.Encoders
{
    ...
    /// <summary>
    /// <see cref="Best.SignalR.IProtocol"/> implementation using the <see href="Json &#38 MessagePack Serialization">https://assetstore.unity.com/packages/tools/network/json-messagepack-serialization-59918</see> asset store package.
    /// </summary>
    public sealed class MessagePackProtocol : Best.SignalR.IProtocol
    {
        ...
        public MessagePackProtocol(MessagePackProtocolSerializationOptions options)
        {
            ...
            GameDevWare.Serialization.Json.DefaultSerializers.AddRange(new TypeSerializer[]
            {
                ...
                new Best.SignalR.Encoders.Vector2Serializer(),
                new Best.SignalR.Encoders.Vector3Serializer(),
                new Best.SignalR.Encoders.Vector4Serializer(),
